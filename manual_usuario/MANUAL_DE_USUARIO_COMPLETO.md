...
> **Versión de Referencia:** Este documento y sus guías visuales corresponden a **tribuTACOS v1.1.0 STABLE**.
...
> **Versión de Referencia:** Este documento y sus guías visuales corresponden a **tribuTACOS v1.1.0 STABLE** (Frontend Next.js 15 / Backend FastAPI).
