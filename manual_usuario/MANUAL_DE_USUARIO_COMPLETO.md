...
> **Versión de Referencia:** Este documento y sus guías visuales corresponden a **tribuTACOS v1.1.0-rc.2 RC**.
...
> **Versión de Referencia:** Este documento y sus guías visuales corresponden a **tribuTACOS v1.1.0-rc.2 RC** (Frontend Next.js 15 / Backend FastAPI).
