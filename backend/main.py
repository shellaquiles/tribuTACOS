...
def get_summary():
    ...
    for item in nomina_items:
        ...
        d = item.get('nomina_detalle_exento', {})
        det_ex['aguinaldo'] += d.get('aguinaldo', 0)
        det_ex['ptu'] += d.get('ptu', 0)
        det_ex['prima_vacacional'] += d.get('prima_vacacional', 0)
        det_ex['prima_dominical'] += d.get('prima_dominical', 0)
        det_ex['otros'] += d.get('otros', 0)
