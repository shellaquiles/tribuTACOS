...
graph TD
    ...
    A --> F[Módulo 4: Ingresos y Nómina]
    A --> G[Módulo 5: Auditoría Oficial SAT]
    A --> H[Herramientas de Exportación & Auditoría]

    C --> C1[Dashboard Global]
    D --> D1[Pre-Declaración Mensual ISR/IVA]
    D --> D2[Pre-Declaración Anual LISR Art. 152]
    E --> E1[Gastos y Compras - Bancarización]
    E --> E2[Deducciones Personales Art. 151]
    F --> F1[Sueldos y Salarios - Art. 93]
    F --> F2[Detalle de Recibos de Nómina]
    F --> F3[Honorarios y AEyP - Flujo Efectivo]
    F --> F4[Facturación Clientes y Claves SAT]
    G --> G1[Conciliación Oficial de PDFs]
    G --> G2[Matriz de Pagos Provisionales]
    G --> G3[Liquidación Anual y CLABE Devolución]
```
